...
export default function AuthForm() {
  ...
  if (loggedEmail) {
    return (
      <div style={panel}>
        <div style={{ fontSize: 12, fontWeight: 900, color: '#4ec6ff', letterSpacing: '.08em' }}>
          CONTA ALÔ ID
        </div>
        ...
        <p style={{ color: '#9fb3c7', marginTop: 0 }}>
          {loggedEmail}
        </p>
      ...
      {message && (
        <div
          style={{
            ...
            padding: '12px 14px',
            borderRadius: 12,
            background: 'rgba(25,87,130,.25)',
            border: '1px solid rgba(70,160,230,.25)',
            color: '#c7e8ff',
            fontSize: 13,
            lineHeight: 1.45,
          }}
...
const input: React.CSSProperties = {
  ...
  height: 52,
  borderRadius: 12,
  border: '1px solid rgba(91,145,195,.4)',
  background: '#08182b',
  color: '#fff',
  padding: '0 14px',
  fontSize: 16,
...
const secondaryButton: React.CSSProperties = {
  ...
  padding: '0 18px',
  borderRadius: 11,
  border: '1px solid rgba(85,145,210,.45)',
  background: 'transparent',
  color: '#9dcbef',
  fontWeight: 800,
  cursor: 'pointer',
